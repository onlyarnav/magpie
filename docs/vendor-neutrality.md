...
**Overall vendor-neutrality score: 9/10 capability contracts (90%).** Generated by [`tools/vendor-neutrality-score`](../tools/vendor-neutrality-score/); re-run it to refresh this section.
