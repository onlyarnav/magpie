...
need, a complete :class:`GitBackend`, a complete :class:`FossilBackend`, and
explicit extension points for the non-Git/non-Fossil VCS bridges
(Mercurial #601, Subversion #602, Jujutsu #603, Perforce #605).
